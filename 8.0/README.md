...
docker run --detach --interactive --tty --rm --name my-running-php8.0-fpm --volume /var/www:/var/www --workdir /var/www --publish 127.0.0.1:9074:9000 my-php8.0-fpm
```
...
docker run --detach --interactive --tty --rm --name my-running-php8.0-fpm --volume /var/www:/var/www --workdir /var/www --publish 127.0.0.1:9074:9074 my-php8.0-fpm
```
